...
<h1 style={{fontSize:'2.5rem',fontWeight:'bold',textAlign:'center'}}><span style={{color:'#d4af37'}}>ITS-R</span> Airtable</h1>
<p style={{color:'#94a3b8',textAlign:'center',marginTop:'1rem'}}>Productivity Suite — ITS-R Universe</p>
